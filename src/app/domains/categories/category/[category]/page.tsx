...
import { listedCategoryCount, activeCategoryDomains } from "@/components/categoryDomains";
...
export async function generateMetadata({
  ...
  try {
    ...
    const description = `Explore ${listedCategoryCount(categoryData.domains)} premium KNS domains in the ${category} category. Perfect for Kaspa wallets, identity, and branding.`;
