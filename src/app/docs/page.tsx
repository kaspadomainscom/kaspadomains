        ...
        <div className="space-y-8">
          <Section id="what" title="What is KaspaDomains?">
            <p>
              ...
              holder can list their domain for a one-time <strong>{LISTING_FEE_LABEL}</strong> fee, to get a public
          ...
          <Section id="how" title="How It Works">
            <ul>
              ...
              <li>A one-time <strong>{LISTING_FEE_LABEL}</strong> listing fee — no renewals</li>
          ...
          <Section id="voting" title="Community Voting">
            <p>
              Anyone can support a listed domain for <strong>{VOTE_FEE_LABEL}</strong> per vote, one per
          ...
          <Section id="start" title="Get Started">
            <p>
              ...
              message to confirm the request is yours, then pay the one-time {LISTING_FEE_LABEL} fee from
